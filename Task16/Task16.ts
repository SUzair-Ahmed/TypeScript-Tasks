...
let GuestList_repeat2 = ["Saad", "Kamran", "Meeran"];
...
// Task number 14 for updating program
let GuestList_repeat3 = ["Saad", "Asad", "Meeran"];
...
let GuestList_repeat4 = ["Hashmi","Saad","Uzair", "Asad", "Meeran"];
...
console.log("I would like to invite you at my party for dinner because now we have bigger table"+GuestList_repeat4[5]+"\n");
